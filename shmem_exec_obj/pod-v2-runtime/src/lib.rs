...
impl From<pod_v2_api::HeaderError> for Error {
    fn from(error: pod_v2_api::HeaderError) -> Self {
        Self(error.to_string())
    }
}
...
mod tests {
    use super::*;
    use pod_v2_api::{FLAG_OFFSET_ARENA, METHOD_SPECS, MethodEntry};
