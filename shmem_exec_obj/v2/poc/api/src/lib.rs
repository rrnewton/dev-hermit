...
pub const IMAGE_MAGIC: [u8; 8] = *b"SHPODI1\0";
...
pub const STATE_MAGIC: [u8; 8] = *b"SHPODS1\0";
...
pub const METHOD_SPECS: [(&str, Signature); METHOD_COUNT] = [
    ("shmem_pod_layout_size", Signature::NoArgsU64),
    ("shmem_pod_layout_align", Signature::NoArgsU64),
    ("shmem_pod_layout_hash", Signature::NoArgsU64),
    ("shmem_pod_init", Signature::StateLenStatus),
    ("shmem_pod_validate", Signature::StateLenStatus),
    ("shmem_pod_upsert", Signature::StateKeyDeltaStatus),
    ("shmem_pod_get", Signature::StateKeyOutStatus),
    ("shmem_pod_len", Signature::StateU64),
    ("shmem_pod_allocated", Signature::StateU64),
    ("shmem_pod_capacity", Signature::StateU64),
    ("shmem_pod_snzi_leaf_count", Signature::NoArgsU64),
    ("shmem_pod_snzi_arrive", Signature::StateU64OutStatus),
    ("shmem_pod_snzi_depart", Signature::StateU64Status),
    ("shmem_pod_snzi_query", Signature::StateU64),
    ("shmem_pod_snzi_quiescent", Signature::StateU64),
];
