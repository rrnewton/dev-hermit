...
| cflow | 1:1.4+dfsg1-2 | DIVERGES | pending | pending |
...
| ethtool | 1:3.4.2-1 | DIVERGES | pending | pending |
...
| mtools | 4.0.17-1 | DIVERGES | pending | pending |
...
| numactl | 2.0.8~rc4-1 | DIVERGES | pending | pending |
...
**35/35 packages diverge natively across two build roots. 29/29 measured in the corrected arm are byte-identical under `hermit run --strict --no-rcb-time`.**
