# Hermit end-to-end commands organized by proposed CI bucket.
#
# Source: experiments/ci/e2e_commands.sh at parent commit fd96eb601bda8f57650be637bdab796bf3d86c20.
# Assignment: experiments/ci/e2e_rebucket_proposal.md.
# Every source command appears exactly once; command text and annotations are unchanged.
# This file is intentionally non-executable: runtime-created variables and fixtures
# must be supplied by the owning test harness. Copy individual commands as needed.

# ============================================
# BUCKET: hosted-fast (no HW, <2min each)
# Commands: 258
# ============================================
...
# ============================================
# BUCKET: hosted-medium (no HW, 2-10min)
# Commands: 896
# ============================================
...
# ============================================
# BUCKET: selfhosted-hw (PMU, KVM, CPUID)
# Commands: 8
# ============================================
...
# ============================================
# BUCKET: occasional (expensive, manual trigger)
# Commands: 1
# ============================================
