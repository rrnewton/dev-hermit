# Hermit end-to-end command inventory.
#
...
# This file contains only directly pastable hermit run commands.
# It is intentionally non-executable; it is an audit/runbook, not a suite.
#
# Annotations:
