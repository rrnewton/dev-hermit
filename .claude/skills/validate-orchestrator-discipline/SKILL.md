...
See [compatibility-counter rebases](../validate-sh-rr-compat-counter-conflict/SKILL.md)
and the [historical landing alias](../pr-landing-mechanics-merge-gate-uptodate-chase/SKILL.md)
