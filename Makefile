...
# measure the UNION — the FULL 205-cell verify corpus (184 compiled C + 21
...
# 205-cell cross-backend envelope (both lanes' union); the portable/privileged
...
help:
	...
	@echo "make compat-envelope-fullcorpus  LOCAL full 205-cell union across all runnable backends"
