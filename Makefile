...
# measure the UNION — the FULL 215-cell verify corpus (194 compiled C + 21
...
# 215-cell cross-backend envelope (both lanes' union); the portable/privileged
...
help:
	...
	@echo "make compat-envelope-fullcorpus  LOCAL full 215-cell union across all runnable backends"
